...
New-AzManagementGroupDeployment -Name "initiatives" -ManagementGroupId $ManagementGroupId -Location $Location -TemplateFile $template -TemplateParameterFile $parameters
